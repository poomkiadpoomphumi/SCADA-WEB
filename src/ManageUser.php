...
<body>
  <div class="background-loader" id="loading-p">
    ...
    <h4 class="TAG"><img src="../img/PTT.png" width="35" height="45" style="margin-top:-18px;margin-left:-10px;margin-right:10px;"/><B>MANAGE USER GROUP <?php echo $_GET['GroupName'];?></B></h4>
    <div class="table-container-data-scada" id="loadpage">
        ...
        <a class="btn btn-warning" style="float:left;margin-right:10px;" onclick="Addusers()">
