<?php $_REQUEST[] = htmlspecialchars($_REQUEST[], ENT_QUOTES, 'UTF-8'); ?>
<?php $_REQUEST[cdPartialUpdate] = htmlspecialchars($_REQUEST[cdPartialUpdate], ENT_QUOTES, 'UTF-8'); ?>
<?php $_REQUEST[cdDirectStream] = htmlspecialchars($_REQUEST[cdDirectStream], ENT_QUOTES, 'UTF-8'); ?>
<?php $_REQUEST[cddebug] = htmlspecialchars($_REQUEST[cddebug], ENT_QUOTES, 'UTF-8'); ?>
<?php
